...
@Schema(
        name = "BookingHistoryResponse",
        description = "Summary of a booking returned in customer and administrator booking history."
)
@NoArgsConstructor
@AllArgsConstructor
@Getter
...
public class BookingHistoryResponse {
    ...
    @Schema(
            description = "Date and time when the booking was completed.",
