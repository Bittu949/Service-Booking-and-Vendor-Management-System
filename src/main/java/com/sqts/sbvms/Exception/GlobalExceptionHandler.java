...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleInvalidBookingStateException(InvalidBookingStateException ex){
        return new ResponseEntity<>(
                new ApiResponse<>(
                        false,
                        ex.getMessage(),
    ...
    @ExceptionHandler(VendorServiceNotFoundException.class)
    public ResponseEntity<ApiResponse<Object>> handleVendorServiceNotFoundException(VendorServiceNotFoundException ex){
        return new ResponseEntity<>(
                new ApiResponse<>(
                        false,
                        ex.getMessage(),
